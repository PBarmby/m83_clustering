...
results_225 = Table.read('C:\\Users\\Alex\\Documents\\GitHub\\m83_clustering\\results\\broad_narrow\\UVW_U\\clustering\\mag05_225-mag05_336_mag05_438-mag05_814\\05aperture_results_2d.txt', format='ascii.commented_header', guess=False)
...
# plot 373 
ax.plot(num_clust_373 [results_373['clustering'] == 'kmeans'],
...
ax.plot(num_clust_373 [results_373['clustering'] == 'meanshift'],
...
# plot 225
ax.plot(num_clust225[results_225['clustering'] == 'kmeans'],
...
ax.plot(num_clust225[results_225['clustering'] == 'meanshift'],
...
remove = []
for n in range(0, len(results_225)):
    if results_225['b_width'][n] == 'N/A':
        remove.append(n)
results_225.remove_rows(remove)
...
plt.plot(results_373['b_width'], results_373['score'], marker='o',
            color='r', label='F373W Mean Shift')
plt.plot(results_225['b_width'], results_225['score'], marker='o',
            color='b', label='F225W Mean Shift')
plt.setp(ax1.get_xticklabels(), fontsize=6)
ax2.set_ylabel('Score', fontweight='bold', fontsize=14)
plt.ylim(0.25, 0.75)
ax2.yaxis.set_major_locator(plt.MultipleLocator(0.05))
ax2.legend(loc='best', fontsize=11, scatterpoints=1)

# share x only
ax3 = plt.subplot(212, sharex=ax2)
plt.plot(results_373['b_width'], results_373['n_clust'], marker='o',
            color='r')
plt.plot(results_225['b_width'], results_225['n_clust'], marker='o',
            color='b')
