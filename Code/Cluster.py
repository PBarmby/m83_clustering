# K Means Clustering: Alex Kiar
#Messed up by P. Barmby 
...
def do_cluster(band1, band2, band3, band4, number_clusters=4):
    ...
    #Print number of objects per cluster
    ...
    #pylab.savefig('CLUSTER:'+band1+'-'+band2+ 'vs' +band3+'-'+band4+'.png')
