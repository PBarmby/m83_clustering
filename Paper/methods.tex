...
Generally, k-means begins by selecting $k$ data points at random and deems these points cluster centres. %Generally? When does it not?
...
\end{equation}
Each point, $x$, is then assigned to the cluster centre with the lowest distance in equation~\ref{eq:km_sos}. % use different ref \citet{tammour16}.
...
This process continues until the centres do not change after two consecutive iterations \citet{sanchez-almeida13}. %change by how much?
